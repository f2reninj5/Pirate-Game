...
export default function Instructions() {
  return (
    <article className="prose h-screen">
      ...
      <p>
        You will want to share your screen with all the players via a classroom
        projector, TV, or by screen sharing if playing remotely.
      </p>
      ...
      <Accordion.Root type="single" collapsible={true}>
          ...
          <Accordion.Content>
            <ol>
              <li>
                ...
                <em>Sheets</em> window (which sheet to print is indicated by how
                many players there are).
              </li>
              <li>
                Each player should fill their grid with the different tiles
                listed on the right-hand side. The numbers in brackets indicate
                how many of each tile should be placed in the grid.
              </li>
              <li>Each player begins with 0 cash and 0 money in their bank.</li>
            </ol>
          </Accordion.Content>
        </Accordion.Item>
        ...
        <Accordion.Item value="gameplay">
          ...
          <Accordion.Content>
            <ol>
              ...
              <li>
                For each of the non-cash tiles, the host will ask the players if
                any of them landed on that tile.
                <ol>
                  <li>
                    If one player has landed on the named tile, then they should
                    do whatever the tile's rule says (the tiles on the host's
                    screen also display these rules).
                  </li>
                  <li>
        ...
        <Accordion.Item value="winning">
          ...
          <Accordion.Content>
            <p>
              The winner of the game is the player who has the most money (cash
              and bank combined) after the grid has been completed or after a
              set period of time, e.g. 1 hour, has passed.
            </p>
          </Accordion.Content>
        </Accordion.Item>
